  ...
  >
    ...
    <v-list density="compact" nav class="nav__routes">
      <NuxtLink :to="localePath('/doctor/clinics')">
        <v-list-item :title="t('TITLES.doctor.clinics')" :class="{'v-list-item--active': route.path.includes('doctor/clinics')}">
      ...
      <NuxtLink :to="localePath('/patients')">
        <v-list-item :title="t('TITLES.doctor.patients')" :class="{'v-list-item--active': route.path.includes('doctor/patients')}">
          <template v-slot:prepend>
